...
<html>
<head>
<title>修改<s:if test="gift_peoples.p_flag==1">受礼人</s:if><s:elseif test="gift_peoples.p_flag==0">赠礼人</s:elseif></title>
				...
				<tbody>
					<tr>
						<td align="center" valign="top">
							...
							<form id="form1" action="gift_peoples_update.action" method="post">
								<s:hidden name="gift_peoples.p_flag"/>
								<s:hidden name="gift_peoples.p_id"/>
								<table bgcolor="#cfcfcf" border="0" cellpadding="2" cellspacing="1" width="100%">
									<tbody>
										...
										<tr bgcolor="#FFFFFF">
											<td>
												<label>名　　字:</label>
												<input type="text"  name="gift_peoples.p_name" value='<s:property value="gift_peoples.p_name"/>' />
											</td>
											<td>
												<label>类　　型:</label>
											...
											<td>
												<label>配偶姓名:</label>
												<input type="text"  name="gift_peoples.p_spouse" value='<s:property value="gift_peoples.p_spouse"/>' />
											</td>
										</tr>
										<tr bgcolor="#FFFFFF"><td>
												<label>国　　家:</label>
												<input type="text"  name="gift_peoples.p_country" value='<s:property value="gift_peoples.p_country"/>' />
											</td>
											<td>
												<label>头　　衔:</label>
												<input type="text"  name="gift_peoples.p_title" value='<s:property value="gift_peoples.p_title"/>' />
											</td>
