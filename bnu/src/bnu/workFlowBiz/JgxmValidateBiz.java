...
public class JgxmValidateBiz extends WorkFlowStepRTClassA {
	
	public JgxmValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("人才培养_教改项目_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################人才培养_教改项目_有效性验证#########################");
...
//		
//		String name0 = rsTable.get("ZCR").toString() == null ? "" : rsTable.get("ZCR").toString();
...
//		
//		String RATE0Temp = rsTable.get("ZCRRATE").toString() == null ? "" : rsTable.get("ZCRRATE").toString();
