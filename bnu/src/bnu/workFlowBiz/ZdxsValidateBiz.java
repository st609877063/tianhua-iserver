...
public class ZdxsValidateBiz extends WorkFlowStepRTClassA {
	
	public ZdxsValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("人才培养_指导学生_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################人才培养_指导学生_有效性验证#########################");
