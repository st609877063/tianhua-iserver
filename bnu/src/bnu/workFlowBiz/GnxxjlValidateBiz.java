...
public class GnxxjlValidateBiz extends WorkFlowStepRTClassA {
	
	public GnxxjlValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("教育经历_国内学习经历_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################教育经历_国内学习经历_有效性验证#########################");
