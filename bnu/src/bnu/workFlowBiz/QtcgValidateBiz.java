...
public class QtcgValidateBiz extends WorkFlowStepRTClassA {
	
	public QtcgValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("科研情况_其他成果_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################科研情况_其他成果_有效性验证#########################");
