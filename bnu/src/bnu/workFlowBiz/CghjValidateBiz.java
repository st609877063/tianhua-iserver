...
public class CghjValidateBiz extends WorkFlowStepRTClassA {
	
	public CghjValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("科研情况_成果获奖_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################科研情况_成果获奖_有效性验证#########################");
...
//		String name0 = rsTable.get("MAN").toString() == null ? "" : rsTable.get("MAN").toString();
