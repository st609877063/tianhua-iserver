 ...
 * @version V1.0
*/
public class BnuManagerJbxxWeb extends ActionsoftWeb {
	/**
	 * 构造方法
	 * @param userContext 用户上下文对象
	 */
	public BnuManagerJbxxWeb(UserContext userContext) {
		super(userContext);
...
//		   sb.append("<a href='#' onclick='modify("+id+")'>修改</a></td></table></td>");
//		   sb.append("</tr>\n");
