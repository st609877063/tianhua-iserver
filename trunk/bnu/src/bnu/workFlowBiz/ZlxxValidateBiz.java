...
public class ZlxxValidateBiz extends WorkFlowStepRTClassA {
	
	public ZlxxValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("科研情况_专利信息_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################科研情况_专利信息_有效性验证#########################");
...
//		String name0 = rsTable.get("PATENTEE").toString() == null ? "" : rsTable.get("PATENTEE").toString();
