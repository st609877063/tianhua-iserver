...
public class XszzValidateBiz extends WorkFlowStepRTClassA {
	
	public XszzValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("科研情况_学术著作_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################科研情况_学术著作_有效性验证#########################");
