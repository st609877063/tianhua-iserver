...
public class JxhjValidateBiz extends WorkFlowStepRTClassA {
	
	public JxhjValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("人才培养_教学获奖_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################人才培养_教学获奖_有效性验证#########################");
...
//		
//		String name0 = rsTable.get("FZR").toString() == null ? "" : rsTable.get("FZR").toString();
...
//		
//		String RATE0Temp = rsTable.get("FZRRATE").toString() == null ? "" : rsTable.get("FZRRATE").toString();
