...
public class KyxmValidateBiz extends WorkFlowStepRTClassA {
	
	public KyxmValidateBiz(UserContext uc){
		super(uc);
		super.setDescription("科研情况_科研项目_有效性验证");
	...
	public boolean execute() {
		System.out.println("########################科研情况_科研项目_有效性验证#########################");
