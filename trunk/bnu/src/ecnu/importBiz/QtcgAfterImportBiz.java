...
//			String countSql = "select count(1) totalNum from BO_ECNU_QTCG";
//			int totalNum = DBSql.getInt(conn, countSql, "totalNum");
			
			String sql = "select * from BO_ECNU_QTCG";
...
//					System.out.println("processInstanceId="+processInstanceId+" ,processTaskInstanceIds="+processTaskInstanceIds[0]);
					...
					if(chargeIdBindId != 0) {
						updateLoginIdSql = "update BO_ECNU_QTCG set CHARGEID ='" +loginId +"' "
						+ ", ID1='" +loginId1 + "' "
						+ ", ID2='" +loginId2 + "' "
						+ ", ID3='" +loginId3 + "' "
						+ ", ID4='" +loginId4 + "' "
...
//				System.out.println(updateLoginIdSql);
					...
					if(loginId1 != null && !loginId1.equals("")) {
						...
						int createBoId = BOInstanceAPI.getInstance().createBOData("BO_ECNU_QTCG", recordData, loginId1BindId, "admin");
						if(createBoId == -1) {
...
//					System.out.println("为 "+loginId1+" 共享数据：createBoId="+createBoId+", BINDID="+loginId1BindId);
						String updateCreateBoSql = "UPDATE BO_ECNU_QTCG SET "
							+ "  HAVNAME ='" + havname +"' "
...
//					System.out.println("updateCreateBoSql="+updateCreateBoSql);
					...
					if(loginId2 != null && !loginId2.equals("")) {
						...
						int createBoId = BOInstanceAPI.getInstance().createBOData("BO_ECNU_QTCG", recordData, loginId2BindId, "admin");
						if(createBoId == -1) {
							createBoFailureNum = createBoFailureNum + 1;
						}
						copyDataIds = copyDataIds + createBoId + ":";
...
//					System.out.println("updateCreateBoSql="+updateCreateBoSql);
					...
					if(loginId3 != null && !loginId3.equals("")) {
						...
						int createBoId = BOInstanceAPI.getInstance().createBOData("BO_ECNU_QTCG", recordData, loginId3BindId, "admin");
						if(createBoId == -1) {
							createBoFailureNum = createBoFailureNum + 1;
						}
						copyDataIds = copyDataIds + createBoId + ":";
...
//					System.out.println("updateCreateBoSql="+updateCreateBoSql);
					...
					if(loginId4 != null && !loginId4.equals("")) {
						...
						int createBoId = BOInstanceAPI.getInstance().createBOData("BO_ECNU_QTCG", recordData, loginId4BindId, "admin");
						if(createBoId == -1) {
							createBoFailureNum = createBoFailureNum + 1;
						}
						copyDataIds = copyDataIds + createBoId + ":";
...
//					System.out.println("updateCreateBoSql="+updateCreateBoSql);
					...
					if(loginId5 != null && !loginId5.equals("")) {
						...
						int createBoId = BOInstanceAPI.getInstance().createBOData("BO_ECNU_QTCG", recordData, loginId5BindId, "admin");
						if(createBoId == -1) {
							createBoFailureNum = createBoFailureNum + 1;
						}
						copyDataIds = copyDataIds + createBoId + ":";
...
//					System.out.println("updateCreateBoSql="+updateCreateBoSql);
					...
					String updateCopyDataIdSql = "update BO_ECNU_QTCG set copyDataId ='" +copyDataIds +"' where ID="+dataId;
