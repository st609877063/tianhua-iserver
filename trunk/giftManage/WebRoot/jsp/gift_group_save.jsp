				...
				<tbody>
					<tr>
						<td align="center" valign="top">
							...
							<s:form id="form1" action="gift_group_save.action" method="post">
								<table bgcolor="#cfcfcf" border="0" cellpadding="2" cellspacing="1" width="100%">
									<tbody>
										<tr bgcolor="#E7E7E7">
											<td style="padding-left: 10px;" background="images/tbg.gif" height="24">分组信息 &gt; 添加</td>
									...
									<tr bgcolor="#FFFFFF">
											<td>
												<label>分组名:</label>
												<input type="text" id="group_name"  name="gift_group.group_name" value='<s:property value="gift_group.group_name"/>' />
											</td>
											<td>
												<label>父分组:</label>
