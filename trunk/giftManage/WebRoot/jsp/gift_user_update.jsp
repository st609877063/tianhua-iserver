				...
				<tbody>
					<tr>
						<td align="center" valign="top">
							...
							<form id="form1" action="gift_user_update.action" method="post">
								<s:hidden name="gift_user.user_id"/>
								<!-- 下面两个字段用于更新gift_group_user表 -->
								<s:hidden name="gift_user.create_time"/>
								<s:hidden name="gift_user.add_user_id"/>
								<table bgcolor="#cfcfcf" border="0" cellpadding="2" cellspacing="1" width="100%">
									<tbody>
										<tr bgcolor="#E7E7E7">
											<td style="padding-left: 10px;" background="images/tbg.gif" height="24">人物信息 &gt; 添加</td>
										...
										<tr bgcolor="#FFFFFF">
											<td>
												<label>名　　字:</label>
												<input type="text"  name="gift_user.user_name" value='<s:property value="gift_user.user_name"/>' />
											</td>
											<td>
												<label>密　　码:</label>
												<input type="password"  name="gift_user.password" value=''/>
											</td>
											<td>
												<label>昵　　称:</label>
												<input type="text"  name="gift_user.nick_name" value='<s:property value="gift_user.nick_name"/>'/>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF">
											<td>
												<label>头　　像:</label>
												<input type="text"  name="gift_user.user_img" value='<s:property value="gift_user.user_img"/>'/>
											</td>
											<td>
												<label>头　　衔:</label>
												<input type="text"  name="gift_user.user_title" value='<s:property value="gift_user.user_title"/>'/>
											</td>
											<td>
												<label>用户类型:</label>
