				...
				<tbody>
					<tr>
						<td align="center" valign="top">
							...
							<s:form name="form1" action="gift_group_user_update.action" method="post">
								<s:hidden name="gift_group_user.gu_id"/>
								<table bgcolor="#cfcfcf" border="0" cellpadding="2" cellspacing="1" width="100%">
									<tbody>
										<tr bgcolor="#E7E7E7">
											<td style="padding-left: 10px;" background="images/tbg.gif" height="24">用户组信息 &gt; 修改</td>
