...
function InitNewFrameTab() {
    jQuery("#newFrameTab").click(function() {
        ...
        jQuery('<li id="iFrameTab' + (++lastFrameTabId) + '" ><a href="javascript:"><span id="frameTabTitle">(无标题)</span><a class="closeTab"><img border="0" src="static/images/tab-close.gif"/></a></a></li>')
